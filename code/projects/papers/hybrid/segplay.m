function [] = segplay( seg, alphas, map, ratio )
% 
% Display 3D segmentation as a stack of 2D image slices
% 
% Usage:
%   segplay( segmentation )
%   segplay( segmentation, {alpha1,alpha2,...} )
% 
%   segmentation: 3D segmentation as a stack of 2D image slices
%   alphas: cell array of 3D alpha channels of the same size with segmentation
%           (each alpha channel is re-scaled to [0,1])
%
% Key Control:
%   'up' & 'down'   move up and down along z-direction
%   'c'             change alpha channel color randomly
%   '1', '2', ...   turn on/off segmentation and/or alpha channels
